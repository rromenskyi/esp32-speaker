...
#ifndef MINIMP3_SCRATCH_STORAGE
#define MINIMP3_SCRATCH_STORAGE   /* local modification: see components/minimp3/README.md */
#endif
int mp3dec_decode_frame(mp3dec_t *dec, const uint8_t *mp3, int mp3_bytes, mp3d_sample_t *pcm, mp3dec_frame_info_t *info)
{
    ...
    const uint8_t *hdr;
    bs_t bs_frame[1];
    MINIMP3_SCRATCH_STORAGE mp3dec_scratch_t scratch;
